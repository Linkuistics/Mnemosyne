...
fn test_detect_rust_project() {
    ...
    assert!(signals
        .iter()
        .any(|s| matches!(s, Signal::Language(lang) if lang == "rust")));
}
...
fn test_detect_python_project() {
    ...
    assert!(signals
        .iter()
        .any(|s| matches!(s, Signal::Language(lang) if lang == "python")));
}
...
fn test_detect_project_name_from_git() {
    ...
    assert!(signals
        .iter()
        .any(|s| matches!(s, Signal::ProjectName(name) if name == "my-project")));
}
